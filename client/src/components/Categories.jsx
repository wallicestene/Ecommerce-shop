        ...
        <div className=' flex items-center gap-4 w-full justify-center overflow-x-auto'>
            {
                !loading && (
                    categories?.map((category, index) => (
                        <div key={index} className=' h-32 w-36 border flex-shrink-0 relative bg-slate-100 rounded'>
                            <img src={category.image_url} alt="" className='h-full w-full object-cover px-4' />
